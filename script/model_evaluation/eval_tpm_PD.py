...
csv_path = os.path.join(output_dir, "model_evaluation_metrics_PD_tpm.csv")
...
cm_fig_path = os.path.join(output_dir, "confusion_matrices_PD_tpm.png")
...
plt.title('Combined ROC Curve for PD Classification (TPM data)')
plt.legend(loc="lower right")
plt.grid(True, alpha=0.3)

# Save figure before showing
roc_fig_path = os.path.join(output_dir, "combined_roc_curve_PD_tpm.png")
