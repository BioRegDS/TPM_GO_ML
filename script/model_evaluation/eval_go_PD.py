...
with open("../../1209/parameter/RF_GO_PD_params-500.json", "r") as f:
    rf_params = json.load(f)

# Load LightGBM parameters (Adjust filename as needed)
with open("../../1209/parameter/lgbm_best_GO_PD_params-500.json", "r") as f:
    lgbm_params = json.load(f)

# Load XGBoost parameters (Adjust filename as needed)
with open("../../1209/parameter/xgboost_best_GO_PD_params-500.json", "r") as f:
...
csv_path = os.path.join(output_dir, "model_evaluation_metrics_PD_go.csv")
...
cm_fig_path = os.path.join(output_dir, "confusion_matrices_PD_go.png")
...
plt.title('Combined ROC Curve for PD Classification (GO data)')
plt.legend(loc="lower right")
plt.grid(True, alpha=0.3)

# Save figure before showing
roc_fig_path = os.path.join(output_dir, "combined_roc_curve_PD_go.png")
